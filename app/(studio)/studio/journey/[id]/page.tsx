  ...
  return (
    <>
      ...
      <main className="shell-w" style={{ paddingTop: 22, paddingBottom: 60 }}>
        <Link href={`/studio/lead/${journey.leadId}`} className="t-sm c-3">← {journey.person}</Link>
        ...
        {buying ? (
          ...
          <section className="card p-4" style={{ marginTop: 18 }}>
            ...
            <p className="t-xs c-3" style={{ marginTop: 6, lineHeight: 1.6 }}>
              ...
              room for this person are on <Link className="u" href={`/studio/lead/${journey.leadId}`}>their record</Link>.
            </p>
          </section>
        )}
