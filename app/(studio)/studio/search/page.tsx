        ...
        {!on ? (
          ...
          <div className="card p-4" style={{ marginTop: 20 }}>
            ...
            <p className="t-xs c-3" style={{ marginTop: 6, lineHeight: 1.6 }}>
              Open a buyer from <Link className="u" href="/studio/clients">Relationships</Link> and start a journey. Their
          ...
          <>
            ...
            <ul style={{ marginTop: 8, display: "grid", gap: 8 }}>
              {rows.map((r) => (
                <li key={r.id}>
                  <Link href={`/studio/journey/${r.id}`} className="card p-3 between gap-2 wrap" style={{ display: "flex" }}>
