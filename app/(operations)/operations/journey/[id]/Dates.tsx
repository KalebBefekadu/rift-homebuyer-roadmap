  ...
  return (
    <div className="card p-3">
      ...
      <p className="t-2xs c-4" style={{ marginTop: 2, lineHeight: 1.5 }}>
        ...
        {c.sourceDocumentId ? <> · <a className="u" href={`/api/operations/document?journeyId=${journeyId}&id=${c.sourceDocumentId}`} target="_blank" rel="noreferrer">{docLabel.get(c.sourceDocumentId) ?? "the document"}</a></> : null}
