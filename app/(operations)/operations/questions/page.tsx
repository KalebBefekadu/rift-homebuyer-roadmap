    ...
    <>
      ...
      <main className="shell-w sec" style={{ maxWidth: 760 }}>
        ...
        <div className="row gap-2" style={{ marginTop: 18 }}>
          <Link href="/operations/questions?side=buy" className={`btn btn-sm ${side === "buy" ? "btn-p" : "btn-g"}`}>
            Buyers
          </Link>
          <Link href="/operations/questions?side=sell" className={`btn btn-sm ${side === "sell" ? "btn-p" : "btn-g"}`}>
            Sellers
          </Link>
