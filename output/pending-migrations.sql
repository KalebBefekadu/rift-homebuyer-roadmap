...
-- 45 files, the last 20260929000000_rift_team.
--
...
-- =====================================================================
-- 20260929000000_rift_team.sql  (skipped when public.rift_team_members exists)
-- =====================================================================
do $guard$
begin
  if to_regclass('public.rift_team_members') is not null then
    raise notice '20260929000000_rift_team: already applied, skipped';
    return;
  end if;
  execute $m_20260929000000$
-- ============================================================================
